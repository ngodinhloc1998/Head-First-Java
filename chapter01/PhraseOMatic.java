class PhraseOMatic{
	public static void main(String[] args){
		...
		//Make a set word add to choose from
		...
		String[] wordListTwo = {"empowered", "sticky","valueadded","oriented","centric","distributed","clustered", "branded","outside-the-box", "positioned","networked", "focused", "leveraged", "aligned","targeted", "shared", "cooperative", "accelerated"};
		...
		//find out how many word are in list
		int oneLength = wordListOne.length;
		int twoLength = wordListTwo.length;
		int threeLength = wordListThree.length;

		//generate the three random number
